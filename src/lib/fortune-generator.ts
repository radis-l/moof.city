...
const generateRelationshipFortune = (
  ...
  const relationshipTemplates = {
    Monday: {
      A: ['ความสัมพันธ์ของคุณในช่วงนี้ค่อนข้างดีนะ มีความอบอุ่นแบบเรียบง่าย คนที่เหมาะสมจะเข้ามาเร็วๆ นี้ ความรักแท้กำลังจะปรากฏให้เห็น ใจคุณจะรู้สึกดีขึ้นเรื่อยๆ', 'บุคคลที่คุณคิดถึงอยู่ก็คิดถึงคุณเหมือนกัน อย่ากังวลมากเกินไป ลองสังเกตดูอาจได้คำตอบ ความสัมพันธ์จะค่อยๆ พัฒนาไปในทางที่ดี'],
      B: ['เรื่องสัมพันธ์กับคนอื่นค่อนข้างหลากหลาย บางทีดีบางทีปกติ แต่จะค่อยๆ ดีขึ้น อย่าเร่งรีบมากจนเกินไป ให้เวลากับความรู้สึกที่แท้จริง ทุกอย่างจะเป็นไปได้ดี', 'มีบางคนแอบให้ความสนใจคุณอยู่ เขาอาจยังไม่กล้าแสดงออก ลองเปิดใจรับฟังคำแนะนำจากคนใกล้ชิด บางทีคำตอบอยู่ใกล้ตัวมากกว่าที่คิด'],
      AB: ['เรื่องสัมพันธ์ภาพต่างๆ ทำให้คุณคิดซับซ้อนไปหน่อย บางทีก็สับสนในการตัดสินใจ แต่ใจจะชัดเจนขึ้นเรื่อยๆ ความรู้สึกที่แท้จริงจะค่อยๆ ปรากฏออกมา', 'ช่วงนี้เสน่ห์ของคุณโดดเด่นมาก หลายคนให้ความสนใจ ลองดูคุณภาพมากกว่าจำนวน อดทนรอคนที่เหมาะสม ความรักแท้คุ้มค่ากับการรอคอย'],
      O: ['ความสัมพันธ์กับผู้คนรอบตัวค่อนข้างมั่นคง คนอื่นเห็นคุณค่าในตัวคุณ ความสุขกำลังจะเข้ามาในชีวิต ทุกอย่างจะลงตัวและสวยงาม', 'บุคคลที่เหมาะสมกำลังค่อยๆ เข้ามาใกล้ อาจเป็นคนที่คุณรู้จักอยู่แล้ว ให้เวลาและความธรรมชาติ ความสัมพันธ์ที่ดีจะเกิดขึ้นได้เอง']
    },
    Tuesday: {
      A: ['ความสัมพันธ์ของคุณต้องใช้เวลาหน่อยนะ ไม่ต้องเร่งรีบอะไร มันจะค่อยๆ ดีขึ้นเอง คนดีๆ กำลังเดินทางมา ความสุขแท้จริงกำลังจะมาถึง ให้เวลาและความอดทน', 'บุคคลที่เหมาะสมจะเข้ามาในเร็วๆ นี้ เตรียมใจไว้ให้ดี อย่าปิดใจเกินไป ความสุขกำลังจะมา ความรักที่รอคอยจะคุ้มค่า'],
      B: ['ความสัมพันธ์ที่ดีกำลังจะมาแน่นอน แค่รออีกนิดเดียว อดทนหน่อยนะ สิ่งดีๆ มักมาช้า แต่จะมาในรูปแบบที่สวยงาม ใจคุณจะเต็มไปด้วยความสุข', 'มีบุคคลพิเศษกำลังให้ความสนใจคุณ เขามีความรู้สึกดีๆ แค่รอเวลาที่เหมาะสม เขาเป็นคนที่มีเป้าหมายและความมุ่งมั่น'],
      AB: ['ช่วงนี้เรื่องสัมพันธ์ภาพทำให้สับสนนิดหน่อย แต่มันจะค่อยๆ ชัดเจนขึ้น อย่ากังวลไปมาก ข่าวดีกำลังจะมา ความรู้สึกใหม่ๆ จะเข้ามาให้ชีวิตสดใส', 'เรื่องความสัมพันธ์จะมีการพลิกผันให้ตื่นเต้น เตรียมใจไว้ให้ดี อาจเป็นบุคคลที่ไม่คาดคิด แต่จะทำให้คุณมีความสุข'],
      O: ['ความสัมพันธ์ใหม่ๆ จะเข้ามาอย่างแรง รับได้ไหม? คุณเป็นคนที่น่าสนใจมาก หลายคนจะมาติดต่อพร้อมกัน เตรียมตัวรับความสุขที่กำลังจะมา', 'บุคคลที่มีคุณภาพกำลังเดินทางมาหาคุณ เขามีใจดีและจริงใจมาก นี่จะเป็นสัมพันธ์ที่มีอนาคต และยั่งยืนไปได้นาน']
    },
    Wednesday: {
      A: ['วันนี้ดาวเรียงตัวดี เรื่องสัมพันธ์จะลุล่วงไป คนที่คุณรอกำลังจะปรากฏตัวขึ้น ทุกอย่างจะเริ่มดีขึ้นเรื่อยๆ ความรู้สึกใหม่ๆ จะเข้ามาให้ชีวิตสดใส', 'บุคคลในอดีตที่เคยสนิทจะกลับมาติดต่ อีกครั้ง ครั้งนี้จะดีกว่าเดิม ลองให้โอกาสใหม่ดูสิ อาจจะได้เริ่มต้นใหม่ที่ดีกว่า'],
      B: ['สิ่งดีๆ ที่รอมานานกำลังจะมาถึงแล้ว อดทนมานานขนาดนี้คงจะได้ผลตอบแทน ความสุขรอคุณอยู่ ชีวิตจะเปลี่ยนแปลงไปในทางที่ดีขึ้น', 'บุคคลสำคัญจะแสดงความรู้สึกออกมา ไม่ต้องเดาใจกันอีกแล้ว ทุกอย่างจะชัดเจนขึ้น ความสัมพันธ์จะก้าวไปข้างหน้าได้'],
      AB: ['ความสัมพันธ์กับคนรอบตัวจะมีค่ามาก ดูแลกันดีๆ นะ คนที่อยู่ใกล้คุณเขาดีจริงๆ ให้ความสำคัญกับความสัมพันธ์เหล่านี้', 'ต้องตัดสินใจแล้วว่าจะเลือกใคร หยุดลังเลได้แล้ว บุคคลที่เหมาะสมอยู่ใกล้แล้ว ฟังเสียงหัวใจของตัวเองให้มาก'],
      O: ['ความสัมพันธ์จะเป็นแรงใจให้ทำงานดี มีคนคอยให้กำลังใจอยู่ข้างๆ รู้สึกอบอุ่นไหม ความรักที่มีอยู่จะทำให้แข็งแกร่งขึ้น', 'ข่าวดีเรื่องครอบครัวจะมาในเร็วๆ นี้ อาจเป็นข่าวแต่งงานหรือหมั้นหมาย ความสุขจะขยายออกไปให้คนรอบข้าง']
    },
    Thursday: {
