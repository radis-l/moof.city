...
const generateRelationshipFortune = (
  ...
  const relationshipTemplates = {
    '<18': [
      'ช่วงวัยเรียนนี้ความสัมพันธ์กับเพื่อนจะสำคัญมาก มีเพื่อนใหม่เข้ามาในชีวิต',
      'เรื่องความชอบใจคนอื่นในวัยนี้เป็นเรื่องธรรมชาติ มุ่งเน้นการเรียนและสร้างมิตรภาพ',
      'ความสัมพันธ์ครอบครัวเข้มแข็งขึ้น พ่อแม่เข้าใจคุณมากขึ้น เพื่อนสนิทจะเป็นกำลังใจ'
    ],
    '18-25': [
      'วัยหนุ่มสาวมีโอกาสพบคนที่ถูกใจ อย่าเร่งรีบ ให้เวลาทำความรู้จักกันดีๆ',
      'จะได้เจอความรู้สึกใหม่ที่ตื่นเต้น แต่ควรสมดุลระหว่างความรักและเป้าหมายชีวิต',
      'ความสัมพันธ์จะเป็นแรงผลักดันให้เติบโต ความรักหวานชื่น มิตรภาพดีนำโอกาส'
    ],
    '26-35': [
      'วัยทำงานเริ่มมองหาคู่ชีวิตจริงจัง มีคนเหมาะสมเข้ามาใกล้ พร้อมสร้างครอบครัว',
      'ความรักในวัยนี้เข้มข้นลึกซึ้ง คู่รักช่วยสร้างอนาคตร่วมกัน มีคนในออฟฟิศสนใจ',
      'ความสัมพันธ์ครอบครัวแน่นแฟ้น พบคนดีผ่านงานสังคม มีคนเข้าใจและรักคุณ'
    ],
    '36-45': [
      'วัยกลางคนมีเสถียรภาพ หากโสดจะพบคนมีวุฒิภาวะ มีครอบครัวแล้วจะแข็งแกร่งขึ้น',
      'จะเป็นที่พึ่งครอบครัวและเพื่อน ความสัมพันธ์มีคุณภาพ พบเพื่อนเก่าที่คิดถึง',
      'เป็นแบบอย่างให้คนรุ่นใหม่ มีคนมาขอคำปรึกษา ครอบครัวเป็นแรงผลักดันสำคัญ'
    ],
    '46-55': [
      'ความสัมพันธ์ครอบครัวสำคัญที่สุด ลูกหลานให้ความเคารพรัก หากโสดจะพบคนเข้าใจ',
      'หลานทำให้ชีวิตมีความสุข ท่องเที่ยวกับครอบครัวสร้างความทรงจำดี',
      'ชีวิตเรียบง่ายนำความสุข เพื่อนเก่าติดต่อมาใหม่ มีเวลาให้คู่ชีวิตมากขึ้น'
    ],
    '55+': [
      'วัยผู้สูงอายุเต็มความอบอุ่น ลูกหลานมาเยี่ยมเอาใจใส่ มีเวลาให้คู่ชีวิตเต็มที่',
      'เพื่อนในวัยเดียวกันให้กำลังใจกัน ลูกขอคำปรึกษา มีส่วนร่วมเลี้ยงดูหลาน',
      'ความรักบริสุทธิ์จากลูกหลานเป็นของขวัญดีที่สุด ความสุขเรียบง่ายคือความสุขแท้'
    ]
  }
  
  const bloodRelationshipMessages = {
    'A': 'นิสัยละเอียดใส่ใจ สร้างความสัมพันธ์คุณภาพดี คนรอบข้างรู้สึกอบอุ่นปลอดภัย',
    'B': 'ความเป็นตัวของตัวเองดึงดูดคนเข้าใจ อย่าเปลี่ยนตัวเองเพื่อใคร คนที่ใช่จะรักคุณ',
    'AB': 'ความซับซ้อนของความคิดทำให้เข้าใจคนอื่นได้ดี สร้างความสัมพันธ์ลึกซึ้งได้',
    'O': 'ผู้นำธรรมชาติทำให้คนอื่นพึ่งพิง ใช้อิทธิพลสร้างสรรค์สิ่งดีให้คนรอบข้าง'
  }
