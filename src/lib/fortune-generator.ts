...
const generateRelationshipFortune = (
  ...
  const bloodModifiers = {
    'A': ' ด้วยนิสัยละเอียดรอบคอบ การใส่ใจในรายละเอียดทำให้สัมพันธ์ดี คุณมักคิดถึงความรู้สึกคนอื่น รู้จักดูแลเอาใจใส่ ใครๆ ก็เลยอยากเข้าใกล้คุณ',
    'B': ' ด้วยความเป็นตัวของตัวเอง ความมั่นใจในตนเองดึงดูดคน คุณไม่ชอบทำเป็น เป็นยังไงก็พูดยังงั้น ความตรงไปตรงมาทำให้คนอื่นไว้ใจ', 
    'AB': ' ด้วยความเข้าใจผู้คน การมีใจกว้างช่วยสร้างสัมพันธ์ดี คุณฟังปัญหาคนอื่นเป็น ให้คำแนะนำที่เป็นประโยชน์ เป็นที่พึ่งของเพื่อนฝูง',
    'O': ' ด้วยความเป็นผู้นำโดยธรรมชาติ ความมั่นใจทำให้คนอื่นอยากเข้าใกล้ คุณมีเสน่ห์ในการชักจูงใจคน รวมคนให้ทำงานร่วมกันเก่ง ทุกคนเลยมองคุณเป็นหัวหน้า'
  }
...
const generateHealthFortune = (
  ...
  const ageAdvice = {
    '<18': 'วัยเรียนระวังท่านั่งด้วยนะ การนั่งท่าไม่ดีทำให้กระดูกเสื่อม หาเวลาออกไปเล่นกีฬาบ้าง อย่านั่งดูหน้าจอนานเกินไป ร่างกายต้องการการเคลื่อนไหว',
    '18-25': 'หนุ่มสาวระวังนอนดึกนะ การนอนไม่เพียงพอทำให้ภูมิคุ้มกันตกต่ำ ควรนอนให้ครบ 7-8 ชั่วโมงต่อวัน กินอาหารให้ครบ 5 หมู่ เพื่อสุขภาพที่แข็งแรง',
    '26-35': 'วัยทำงานหาเวลาออกกำลังกายนะ การนั่งนานๆ ทำให้กล้ามเนื้อฝ่อ ลุกยืดเส้นยืดสายทุกชั่วโมง ดื่มน้ำให้เพียงพอ อย่าลืมดูแลใจให้แจ่มใสด้วย',
    '36-45': 'ตรวจสุขภาพประจำปีสม่ำเสมอนะ ร่างกายเริ่มเปลี่ยนแปลงแล้ว เฝ้าระวังโรคประจำตัว ควบคุมน้ำหนักให้พอดี เริ่มทานวิตามินตามคำแนะนำหมอ',
    '46-55': 'พักผ่อนให้เพียงพอ ลดความเครียดลง วัยนี้ควรใช้ชีวิตให้สบายใจ หาเวลาทำในสิ่งที่รักมากขึ้น เอาใจใส่ครอบครัว ใจแจ่มใสช่วยให้กายแข็งแรง',
    '55+': 'ดูแลสุขภาพด้วยใจรักนะ วัยนี้ร่างกายต้องการความเอาใจใส่มากขึ้น กินยาตามเวลา พบแพทย์เป็นประจำ ออกกำลังกายเบาๆ เช่น เดินเล่น ยืดกาย เพื่อสุขภาพที่ดี'
  }
